...
<div class="container">
    <div class="wrapper is-size-6">
        ...
        <div class="wrapped">
            <p>The Alaska Wildfire Daily Tally Count was developed from data provided by the <a href="https://afs.ak.blm.gov/" target="_blank">Alaska Fire Service AK Bureau of Land Management</a>. This website was developed by the <a href="https://www.frames.gov/afsc/home">Alaska Fire Science Consortium (AFSC)</a> and the <a href="https://www.snap.uaf.edu/" title="👍">Scenarios Network for Alaska and Arctic Planning (SNAP)</a>, research groups at the <a href="https://uaf-iarc.org/">International Arctic Research Center (IARC)</a> at the <a href="https://uaf.edu/uaf/">University of Alaska Fairbanks (UAF)</a>.</p>
